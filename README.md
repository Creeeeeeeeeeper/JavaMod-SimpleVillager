...
| 版本 | Fabric Loader | Fabric API | Java |
|---|---|---|---|
| 1.21.1 | 0.17.2+ | 0.116.5+1.21.1 | 21+ |
| 1.21.10 | 0.17.3+ | 0.138.4+1.21.10 | 21+ |
| 1.21.11 | 0.19.3+ | 0.141.6+1.21.11 | 21+ |
| 26.1 | 0.19.3+ | 0.155.2+26.1.2 | 25+ |
| 26.2 | 0.19.3+ | 0.155.0+26.2 | 25+ |
| 26.3 | 0.19.5+ | 0.161.0+26.3 | 25+ |

支持 Minecraft 1.21.1、1.21.10、1.21.11、26.1、26.2 与 26.3 版本
...
>
> 村民声望较高时，交易输入项会显示被划掉的基础价和折扣后的实际价格。
