...
public class CycleTradesButton extends AbstractButton {
    ...
    private static final ResourceLocation ARROW_BUTTON =
            ResourceLocation.fromNamespaceAndPath(SimpleVillagerMod.MOD_ID, "textures/gui/container/arrow_button.png");
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.isHovered()) {
            guiGraphics.blit(ARROW_BUTTON, this.getX(), this.getY(), 0f, 14f, 18, 14, 32, 32);
        } else {
            guiGraphics.blit(ARROW_BUTTON, this.getX(), this.getY(), 0f, 0f, 18, 14, 32, 32);
        }
    }
    ...
    public boolean canCycle() {
        ...
        if (!(mc.screen instanceof MerchantScreen merchantScreen)) return false;
        if (!(merchantScreen.getMenu() instanceof MerchantMenu menu)) return false;
