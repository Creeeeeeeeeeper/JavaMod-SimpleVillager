...
public class SimpleVillagerClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        PICK_UP_KEY = KeyMappingHelper.registerKeyMapping(new KeyMapping(
        ...
        net.minecraft.client.renderer.special.SpecialModelRenderers.ID_MAPPER.put(
                VillagerItemSpecialRenderer.ID,
                VillagerItemSpecialRenderer.Unbaked.MAP_CODEC
        );
    ...
    private void handleCycleTradesKey(Minecraft client) {
        ...
        if (!(client.gui.screen() instanceof net.minecraft.client.gui.screens.inventory.MerchantScreen)) return;
        ClientPlayNetworking.send(new CycleTradesC2SPacket());
    }
    ...
    public static boolean onCycleTradesKeyPressed(KeyEvent event) {
        ...
        if (mc.gui.screen() instanceof net.minecraft.client.gui.screens.inventory.MerchantScreen screen) {
            sendCycleTrades();
