...
public class ConverterScreen extends AbstractContainerScreen<ConverterContainer> {
    ...
    private static final Identifier BACKGROUND = Identifier.fromNamespaceAndPath(SimpleVillagerMod.MOD_ID, "textures/gui/container/converter.png");
    ...
    public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        guiGraphics.text(this.font, Component.translatable("gui.SimpleVillager.input"), this.leftPos + 52, this.topPos + 8, 0x404040, false);
        guiGraphics.text(this.font, Component.translatable("gui.SimpleVillager.output"), this.leftPos + 52, this.topPos + 39, 0x404040, false);
