...
public class VillagerItemSpecialRenderer implements SpecialModelRenderer<VillagerRenderState> {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("simplevillager", "villager");
    ...
    public void getExtents(Set<Vector3f> extents) {
        float h = 2.0f;
        float w = 0.5f;
        extents.add(new Vector3f(-w, 0.0f, -w));
        extents.add(new Vector3f(w, 0.0f, -w));
        extents.add(new Vector3f(-w, -h, -w));
        extents.add(new Vector3f(w, -h, -w));
        extents.add(new Vector3f(-w, 0.0f, w));
        extents.add(new Vector3f(w, 0.0f, w));
        extents.add(new Vector3f(-w, -h, w));
