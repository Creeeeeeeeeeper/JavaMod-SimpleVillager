...
public class SimpleVillagerMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        PayloadTypeRegistry.serverboundPlay().register(PickUpVillagerC2SPacket.TYPE, PickUpVillagerC2SPacket.STREAM_CODEC);
        PayloadTypeRegistry.serverboundPlay().register(SelectTradeC2SPacket.TYPE, SelectTradeC2SPacket.STREAM_CODEC);
        PayloadTypeRegistry.serverboundPlay().register(CycleTradesC2SPacket.TYPE, CycleTradesC2SPacket.STREAM_CODEC);
